/**
 * Script to create Minecraft 1.12.2 client version
...
async function createVersion1122() {
  try {
    ...
    const clientVersion = await prisma.clientVersion.create({
      data: {
        ...
        description: 'Minecraft 1.12.2 client version',
        clientJarPath: './updates/1.12.2/client.jar', // Update this path
        ...
        jvmVersion: '8', // Minecraft 1.12.2 requires Java 8
        jvmArgs: [
          '-XX:+UseG1GC',
    ...
    console.log(`   1. Download Minecraft 1.12.2 client files`);
